...
void main() {
    // Displace the UV
    vec2 displacedUv = vUv + cnoise(vec3(vUv * 5.0, uTime * 0.1)); // the cNoise is now added both to the x and to the y

    // Perlin noise
    float strength = cnoise(vec3(displacedUv * 5.0, uTime * 0.2)); // this shows just the black and white
